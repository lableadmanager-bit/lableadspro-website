...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "NIH, VA, and NSF grants are typically processed the same week they are awarded. Other agencies may have a slight delay due to their release schedules, but rest assured - your Monday report includes every newly awarded grant detected during the prior week.",
  },
  {
