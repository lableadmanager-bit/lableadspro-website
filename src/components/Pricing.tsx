const plans = [
  {
    ...
    price: "$49",
    period: "/state/month",
    description: "Be the first to know when new labs open in your territory.",
    features: [
      "New faculty appointments & lab openings",
      "First-time NIH/NSF grant recipients",
      "PI contact information included",
  ...
  {
    name: "Weekly Grant Alert",
    price: "$99",
    period: "/state/month",
    description: "The full picture — every new grant in your territory, tagged and ready.",
    features: [
      "Everything in New Lab Alert",
      "All newly awarded NIH & NSF grants",
      "AI equipment category tagging",
      "Full funding details & grant amounts",
      "Priority email delivery Monday AM",
