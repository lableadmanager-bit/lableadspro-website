    ...
    <section className="relative pt-32 pb-20 px-6 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <p className="animate-fade-in-up-delay-2 text-base md:text-lg text-[var(--color-gray-500)] max-w-2xl mx-auto mb-10 leading-relaxed">
          Subscribers also gain access to our easy-to-search, easy-to-filter grant database, including over 450,000 grants awarded to over 150,000 PIs, covering all actively funded research grants from every federal research agency.
        </p>
