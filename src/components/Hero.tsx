    ...
    <section className="relative pt-32 pb-20 px-6 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <p className="animate-fade-in-up-delay-2 text-lg md:text-xl text-[var(--color-gray-500)] max-w-2xl mx-auto mb-10 leading-relaxed">
          Lab Leads Pro is the AI-powered lead intelligence solution for <span className="whitespace-nowrap">life-science equipment sales.</span> We help get you in front of funded labs looking for your kind of equipment, before the competition does.
        </p>
