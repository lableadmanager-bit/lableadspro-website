...
export const metadata: Metadata = {
  ...
  description:
    "Explore 525,600 actively funded federal research grants across 8 agencies. Guides, grant types, and search tools built for life-science equipment sales reps.",
  keywords:
  ...
  openGraph: {
    title: "Federal Research Grants Database | Lab Leads Pro",
    description:
      "525,600 grants across 8 agencies. The research funding database built for equipment sales.",
      ...
      <section className="relative pt-28 pb-16 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-[var(--color-gray-600)] max-w-2xl mx-auto">
            525,600 actively funded research grants across 8 federal agencies.
