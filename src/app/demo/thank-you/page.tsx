...
export default function DemoThankYouPage() {
  useEffect(() => {
    // Fires GA4 `demo_booked` AND Google Ads conversion AW-18071547440/1nNxCLK6obocELDcl6lD
    // (the "Demo Booked (Calendly thank-you)" action — BOOK_APPOINTMENT, primary for goal).
